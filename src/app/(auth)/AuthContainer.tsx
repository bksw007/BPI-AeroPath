...
export function AuthContainer({ mode, children, onToggleMode }: AuthContainerProps) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 py-4 md:py-8" style={{ perspective: "2000px" }}>
      <motion.div 
        layout
        className="relative bg-white/40 backdrop-blur-2xl border border-white/40 shadow-[0_45px_150px_-20px_rgba(0,0,0,0.22)] rounded-[4rem] overflow-hidden min-h-[500px] md:min-h-[580px] flex flex-col md:flex-row transform-gpu transition-all duration-700"
      >
