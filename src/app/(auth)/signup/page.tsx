    ...
    <AuthContainer mode="signup" onToggleMode={handleToggleMode}>
      <div className="w-full">
        ...
        <div className="mb-8 md:hidden text-center">
           <h1 className="text-3xl font-black text-slate-900 uppercase italic tracking-tighter">Create Account</h1>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-[9px] uppercase tracking-[0.3em]">
            <span className="bg-[#f6edde] px-3 text-slate-400 font-bold">New Terminal</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-[#f6edde] border-2 border-slate-100 rounded-2xl focus:border-slate-900 outline-none transition-all placeholder:text-slate-200 font-bold text-slate-800 text-sm"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 bg-[#f6edde] border-2 border-slate-100 rounded-2xl focus:border-slate-900 outline-none transition-all placeholder:text-slate-200 font-bold text-slate-800 text-sm"
                  placeholder="••••••••"
                  required
                  minLength={6}
                />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4.5 bg-slate-900 hover:bg-black text-white rounded-2xl font-black transition-all shadow-2xl flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed hover:scale-[1.02] active:scale-[0.98] mt-4 text-[11px] uppercase tracking-[0.3em] italic"
          >
            {loading ? (
