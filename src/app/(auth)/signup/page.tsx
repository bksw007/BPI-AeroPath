      ...
      <div className="w-full">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-[10px] uppercase tracking-widest">
            <span className="bg-transparent px-2 text-slate-400 font-bold backdrop-blur-md">Or register email</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-indigo-500 transition-all duration-300" />
              <input
                type="text"
                value={name}
                onChange={(e) => setName(e.target.value)}
                className="w-full pl-12 pr-4 py-2.5 bg-white/50 border border-white/50 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-400/50 outline-none transition-all placeholder:text-slate-300 font-medium"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-2.5 bg-white/50 border border-white/50 rounded-2xl focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-400/50 outline-none transition-all placeholder:text-slate-300 font-medium text-sm"
                  placeholder="••••••••"
                  required
                  minLength={6}
                />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 bg-indigo-600 hover:bg-slate-800 text-white rounded-2xl font-bold transition-all shadow-lg shadow-indigo-500/25 flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed hover:scale-[1.02] active:scale-[0.98] mt-4 text-sm"
          >
            {loading ? (
