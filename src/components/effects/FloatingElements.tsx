  ...
  return (
    <>
      ...
      <ParallaxElement depth={0.015} speed="slow" className="absolute top-20 left-10 pointer-events-none">
        <div className="w-32 h-32 bg-gradient-to-br from-indigo-200/30 to-purple-200/30 rounded-full blur-2xl" />
      </ParallaxElement>
      ...
      <ParallaxElement depth={0.03} speed="medium" className="absolute top-40 right-20 pointer-events-none">
        <div className="w-40 h-40 bg-gradient-to-br from-cyan-200/30 to-blue-200/30 rounded-full blur-3xl" />
      </ParallaxElement>
      ...
      <ParallaxElement depth={0.05} speed="fast" className="absolute bottom-40 left-32 pointer-events-none">
        <div className="w-24 h-24 bg-gradient-to-br from-pink-200/30 to-rose-200/30 rounded-full blur-xl" />
      </ParallaxElement>
      ...
      <ParallaxElement depth={0.025} speed="medium" className="absolute bottom-20 right-40 pointer-events-none">
        <div className="w-36 h-36 bg-gradient-to-br from-yellow-200/30 to-orange-200/30 rounded-full blur-2xl" />
      </ParallaxElement>
